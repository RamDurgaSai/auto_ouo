...
class Log():
    ...
    def __init__(self, file: str,debug_mode:bool = True):
        """
    ...
    def debug(self, msg: str, to_print: bool =False):
        """
        to Debug some info
    ...
    def error(self, msg, to_print: bool = False):
        """
       to Debug some Error
       :param msg: s string to log
       :param print: Pass True to print string n stdout(Defaults to True)
    ...
    def warn(self, msg, to_print: bool = False):
        """
